...
3. Open the Arduino IDE, then select in the menu: **File -> Preferences** (**Arduino -> Preferences** for Mac).  
   ...
   ```
   ![File -> Preferences](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/file_preferences.png)
   
4. In the Arduino IDE menu open: **Tools -> Board -> Boards Manager**.  
   Search for ```esp8266```, and install it:
   ![Tools -> Board -> Boards Manager](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/boards_manager.png)
...
4. Click on **Verify** button and make sure that example compiled correctly:
   ...
   ![Verify](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/verify.png)
...
2. Follow the steps in WiFi provisioning wizard to connect the hardware to your WiFi network:
   ...
   **Note**: you may be asked for a permission to access GPS. It's a regular Android OS permission to get the hardware identifiers during scanning for WiFi networks.
   ...
   ![Step 2](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/provisioning_choose_network.png)
   
   * Choose **Blynk myPlant** device in the list of networks. This is the board which will be configured. 
   
   ![Step 3](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/provisioning_connect.png)
   ...
   * Click **DONE**: 
   ...
   ![Step 4](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/provisioning_done.png)

3. The app is ready to be used.
   
   ![App Ready](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/demo_app.png)
...
![0](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/states/0.png)  Fast Blinking Blue: WAIT_CONFIG mode - Device acts as an Access Point (broadcasts it's own WiFi network). It's waiting for the app to pass the required information

![1](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/states/1.png)  CONFIGURING mode - device is getting the data from the smartphone

![2](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/states/2.png)  Blinking Blynk Green: CONNECTING_NET mode - device is connecting to the WiFi network

![3](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/states/3.png)  Fast Blinking Blynk Green: CONNECTING_CLOUD - device is trying to connect to Blynk Cloud

![4](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/states/4.png)  Breathing Blynk Green: RUNNING - device successfully connected to Blynk Cloud

![6](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/states/6.png)  Blinking Red: ERROR mode

![7](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/states/7.png)  Breathing White - confirming resetting the board configuration

![8](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/states/8.png)  Blinking White - board configuration was reset
...
Like this : 
   ...
   ![Error Download](https://raw.githubusercontent.com/blynkkk/blynkkk.github.io/master/images/demo/error_download_mac.png)
