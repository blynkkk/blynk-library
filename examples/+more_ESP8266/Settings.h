...
#define BOARD_NAME "Test Device"      // Name of your product. Should match App Export request info.
#define BOARD_VENDOR "more"           // Name of your company. Should match App Export request info.
#define BOARD_TEMPLATE_ID "TMPL00010" // ID of the Tile Template. Can be found in Tile Template Settings

#define PRODUCT_WIFI_SSID "+more - Test"     // Name of the device, to be displayed during configuration. Should match export request info.
