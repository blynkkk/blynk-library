...
#ifndef BlynkSimpleDanyboardM0_h
#define BlynkSimpleDanyboardM0_h

#ifdef DANYBOARD_M0
#error This code is not intended to run on the DANYBOARD_M0 platform! Please check your Tools->Board setting.
#endif

#ifndef BLYNK_INFO_CONNECTION
#define BLYNK_INFO_CONNECTION  "DANYBOARD_M0"
#endif
